...
function getAverage(value1, value2) {
  ...
  return value1 + value2 === 0 ? 0 : value1 / 2 + value2 / 2;
}
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  return Math.acos(
    // eslint-disable-next-line no-restricted-properties, operator-linebreak
    ((x1 * x2 + y1 * y2) / Math.sqrt(Math.pow(x1, 2) + Math.pow(y1, 2))) *
      // eslint-disable-next-line no-restricted-properties, comma-dangle
